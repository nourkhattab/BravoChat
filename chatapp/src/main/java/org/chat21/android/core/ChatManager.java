...
public class ChatManager {
    ...
    List<String> restrictedUsersIds;
    ...
    private ChatManager() {
        ...
        restrictedUsersIds = new ArrayList<>();
    }
    ...
    public List<String>  getRestrictedUsersIds() {
        return restrictedUsersIds;
    }

    public void setRestrictedUsersIds(List<String> restrictedUsersIds) {
