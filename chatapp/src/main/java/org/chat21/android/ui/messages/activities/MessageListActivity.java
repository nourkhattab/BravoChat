    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (contactsSynchronizer != null) {
            ...
            if(matchedContact != null) {
                ...
                //check if user in restricted users list
                if(!isValidUser()){
...
//            actionBar.setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.colorPrimary)));
    ...
    private boolean isValidUser() {
        ...
        else return isInternetAvailable();
    ...
    public void isUserOnline(boolean isConnected) {
        ...
        if (isConnected) {
            ...
            if (conversWithLastOnline != PresenceHandler.LAST_ONLINE_UNDEFINED) {
                String subtitleTxt = getString(R.string.activity_message_list_convers_with_presence_last_seen)
                        + TimeUtils.getFormattedTimestamp(this, conversWithLastOnline);
                mSubTitleTextView.setText(subtitleTxt);
                Log.d(DEBUG_USER_PRESENCE, "MessageListActivity.isUserOnline: " +
